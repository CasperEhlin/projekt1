...
/*
     ...
     {task2Total+= parseFloat(task2avg[i].value)}// lägger samman värdena i arrayen
       task2Average=(task2Total/task2avg.length);// räknar ut medelvärde
          ...
          for(var i=0;i<task3avg.length;i++)
             {task3Total+= parseFloat(task3avg[i])}// lägger samman värdena i arrayen
               task3Average=(task3Total/task3avg.length);// räknar ut medelvärde
                  ...
                  let task2avg=$(".provsvar div:nth-child(4) .answer"), task2Total=0,task2Average=0;
                  for(var i=0;i<task4avg.length;i++)
                     {task4Total+= parseFloat(task4avg[i])}// lägger samman värdena i arrayen
                       task4Average=(task4Total/task4avg.length);// räknar ut medelvärde
                          ...
                          let task2avg=$(".provsvar div:nth-child(5) .answer"), task2Total=0,task2Average=0;
                            for(var i=0;i<task5avg.length;i++)
                              {task5Total+= parseFloat(task5avg[i])}// lägger samman värdena i arrayen
  ...
  */
                                    let klassavg=$(""), klassTotal=0,klassAverage=0;
                                    for(let i=0;i<klassavg.length;i++)
                                     {klassTotal+= parseFloat(klassavg[i])}// lägger samman värdena i arrayen
